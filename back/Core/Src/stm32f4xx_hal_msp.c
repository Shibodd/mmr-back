...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(ADC_CLUTCH_CURRENT_GPIO_Port, ADC_CLUTCH_CURRENT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(ADC_CLUTCH_LEVER_POSITION_GPIO_Port, ADC_CLUTCH_LEVER_POSITION_Pin);

    HAL_GPIO_DeInit(ADC_CLUTCH_POSITION_GPIO_Port, ADC_CLUTCH_POSITION_Pin);
